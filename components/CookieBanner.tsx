    ...
    >
      <div className="container mx-auto max-w-4xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex-1">
          <h2 id="cookie-banner-title" className="font-outfit font-semibold text-black text-sm sm:text-base mb-1">
            Uso de cookies
          </h2>
          <p id="cookie-banner-desc" className="font-outfit font-semibold text-black/85 text-xs sm:text-sm">
        ...
        <div className="flex flex-shrink-0 gap-3">
          <button
            type="button"
            onClick={reject}
            className="px-4 py-2 rounded-lg text-sm font-medium bg-transparent border border-black text-black hover:bg-black/10 hover:scale-[1.02] transition-all duration-200"
          >
            Rechazar
          </button>
          <button
