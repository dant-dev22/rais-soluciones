...
function PackageCard({
  ...
  return (
    ...
    >
      ...
      <h4
        id={`pkg-${pkg.id}-title`}
        className="font-outfit text-xl sm:text-2xl font-bold text-rais-offwhite text-center mb-2"
      >
        {pkg.title}
      </h4>

      <p className="text-center text-rais-offwhite/60 text-xs sm:text-sm font-medium mb-1">
        desde
      </p>
      ...
      <div className="mt-6">
        <a
          ...
          className="inline-flex w-full items-center justify-center gap-2 bg-rais-success text-rais-on-accent px-6 py-3 rounded-lg font-semibold hover:bg-rais-success/90 hover:shadow-lg hover:shadow-rais-success/20 hover:scale-[1.02] transition-all duration-200 text-sm sm:text-base"
        >
